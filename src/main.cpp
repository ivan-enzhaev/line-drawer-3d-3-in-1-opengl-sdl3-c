...
void update_projection(void *appState, int width, int height)
{
    ...
    vec3 eye = { 100.f, 50.f, 200.f }; // Camera pulled back on the Z-axis
...
SDL_AppResult SDL_AppIterate(void *appState)
{
    ...
    LineDrawer_draw(app->lineDrawer, origin, xAxis, xColor, 2.f);

    // Y-axis
    vec3 yAxis = { 0.f, axisLength, 0.f };
    vec3 yColor = { 0.f, 1.f, 0.f };
    LineDrawer_draw(app->lineDrawer, origin, yAxis, yColor, 2.f);

    // Z-axis
    vec3 zAxis = { 0.f, 0.f, axisLength };
    vec3 zColor = { 0.f, 0.f, 1.f };
    LineDrawer_draw(app->lineDrawer, origin, zAxis, zColor, 2.f);
